...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.DetailedProjectApiResult();
  });
  ...
  describe('DetailedProjectApiResult', function() {
    it('should create an instance of DetailedProjectApiResult', function() {
      // uncomment below and update the code to test DetailedProjectApiResult
      //var instance = new TestitApiClient.DetailedProjectApiResult();
      //expect(instance).to.be.a(TestitApiClient.DetailedProjectApiResult);
    });
