...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.SearchWebhooksQueryModel();
  });
  ...
  describe('SearchWebhooksQueryModel', function() {
    it('should create an instance of SearchWebhooksQueryModel', function() {
      // uncomment below and update the code to test SearchWebhooksQueryModel
      //var instance = new TestitApiClient.SearchWebhooksQueryModel();
      //expect(instance).to.be.a(TestitApiClient.SearchWebhooksQueryModel);
    });
