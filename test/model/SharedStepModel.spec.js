...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.SharedStepModel();
  });
  ...
  describe('SharedStepModel', function() {
    it('should create an instance of SharedStepModel', function() {
      ...
      //var instance = new testit_api_client.SharedStepModel();
      //expect(instance).to.be.a(testit_api_client.SharedStepModel);
    });
