...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.SharedStepModel();
  });
  ...
  describe('SharedStepModel', function() {
    it('should create an instance of SharedStepModel', function() {
      // uncomment below and update the code to test SharedStepModel
      //var instance = new TestitApiClient.SharedStepModel();
      //expect(instance).to.be.a(TestitApiClient.SharedStepModel);
    });
