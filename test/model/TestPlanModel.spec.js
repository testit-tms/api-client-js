...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestPlanModel();
  });
  ...
  describe('TestPlanModel', function() {
    it('should create an instance of TestPlanModel', function() {
      // uncomment below and update the code to test TestPlanModel
      //var instance = new TestitApiClient.TestPlanModel();
      //expect(instance).to.be.a(TestitApiClient.TestPlanModel);
    });
