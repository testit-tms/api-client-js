...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkflowApiResult();
  });
  ...
  describe('WorkflowApiResult', function() {
    it('should create an instance of WorkflowApiResult', function() {
      // uncomment below and update the code to test WorkflowApiResult
      //var instance = new TestitApiClient.WorkflowApiResult();
      //expect(instance).to.be.a(TestitApiClient.WorkflowApiResult);
    });
