...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AutoTest();
  });
  ...
  describe('AutoTest', function() {
    it('should create an instance of AutoTest', function() {
      // uncomment below and update the code to test AutoTest
      //var instance = new TestitApiClient.AutoTest();
      //expect(instance).to.be.a(TestitApiClient.AutoTest);
    });
