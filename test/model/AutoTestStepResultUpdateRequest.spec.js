...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AutoTestStepResultUpdateRequest();
  });
  ...
  describe('AutoTestStepResultUpdateRequest', function() {
    it('should create an instance of AutoTestStepResultUpdateRequest', function() {
      // uncomment below and update the code to test AutoTestStepResultUpdateRequest
      //var instance = new TestitApiClient.AutoTestStepResultUpdateRequest();
      //expect(instance).to.be.a(TestitApiClient.AutoTestStepResultUpdateRequest);
    });
