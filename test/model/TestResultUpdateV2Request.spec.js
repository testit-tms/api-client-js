...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestResultUpdateV2Request();
  });
  ...
  describe('TestResultUpdateV2Request', function() {
    it('should create an instance of TestResultUpdateV2Request', function() {
      // uncomment below and update the code to test TestResultUpdateV2Request
      //var instance = new TestitApiClient.TestResultUpdateV2Request();
      //expect(instance).to.be.a(TestitApiClient.TestResultUpdateV2Request);
    });
