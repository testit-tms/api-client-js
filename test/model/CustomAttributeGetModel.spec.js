...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.CustomAttributeGetModel();
  });
  ...
  describe('CustomAttributeGetModel', function() {
    it('should create an instance of CustomAttributeGetModel', function() {
      // uncomment below and update the code to test CustomAttributeGetModel
      //var instance = new TestitApiClient.CustomAttributeGetModel();
      //expect(instance).to.be.a(TestitApiClient.CustomAttributeGetModel);
    });
