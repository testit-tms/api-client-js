...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.FailureClassModel();
  });
  ...
  describe('FailureClassModel', function() {
    it('should create an instance of FailureClassModel', function() {
      // uncomment below and update the code to test FailureClassModel
      //var instance = new testit_api_client.FailureClassModel();
      //expect(instance).to.be.a(testit_api_client.FailureClassModel);
    });
