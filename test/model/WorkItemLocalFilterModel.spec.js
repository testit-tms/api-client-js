...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemLocalFilterModel();
  });
  ...
  describe('WorkItemLocalFilterModel', function() {
    it('should create an instance of WorkItemLocalFilterModel', function() {
      // uncomment below and update the code to test WorkItemLocalFilterModel
      //var instance = new TestitApiClient.WorkItemLocalFilterModel();
      //expect(instance).to.be.a(TestitApiClient.WorkItemLocalFilterModel);
    });
