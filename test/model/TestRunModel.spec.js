...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.TestRunModel();
  });
  ...
  describe('TestRunModel', function() {
    it('should create an instance of TestRunModel', function() {
      // uncomment below and update the code to test TestRunModel
      //var instance = new testit_api_client.TestRunModel();
      //expect(instance).to.be.a(testit_api_client.TestRunModel);
    });
