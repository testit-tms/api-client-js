...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.CustomAttributeApiResult();
  });
  ...
  describe('CustomAttributeApiResult', function() {
    it('should create an instance of CustomAttributeApiResult', function() {
      // uncomment below and update the code to test CustomAttributeApiResult
      //var instance = new TestitApiClient.CustomAttributeApiResult();
      //expect(instance).to.be.a(TestitApiClient.CustomAttributeApiResult);
    });
