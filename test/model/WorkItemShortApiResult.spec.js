...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemShortApiResult();
  });
  ...
  describe('WorkItemShortApiResult', function() {
    it('should create an instance of WorkItemShortApiResult', function() {
      // uncomment below and update the code to test WorkItemShortApiResult
      //var instance = new TestitApiClient.WorkItemShortApiResult();
      //expect(instance).to.be.a(TestitApiClient.WorkItemShortApiResult);
    });
