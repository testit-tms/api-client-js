...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AutoTestStepResult();
  });
  ...
  describe('AutoTestStepResult', function() {
    it('should create an instance of AutoTestStepResult', function() {
      // uncomment below and update the code to test AutoTestStepResult
      //var instance = new TestitApiClient.AutoTestStepResult();
      //expect(instance).to.be.a(TestitApiClient.AutoTestStepResult);
    });
