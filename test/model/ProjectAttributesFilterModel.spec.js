...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.ProjectAttributesFilterModel();
  });
  ...
  describe('ProjectAttributesFilterModel', function() {
    it('should create an instance of ProjectAttributesFilterModel', function() {
      // uncomment below and update the code to test ProjectAttributesFilterModel
      //var instance = new TestitApiClient.ProjectAttributesFilterModel();
      //expect(instance).to.be.a(TestitApiClient.ProjectAttributesFilterModel);
    });
