...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.UserWithRankModel();
  });
  ...
  describe('UserWithRankModel', function() {
    it('should create an instance of UserWithRankModel', function() {
      ...
      //var instance = new TestitApiClient.UserWithRankModel();
      //expect(instance).to.be.a(TestitApiClient.UserWithRankModel);
    });
