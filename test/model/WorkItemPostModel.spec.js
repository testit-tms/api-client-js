...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.WorkItemPostModel();
  });
  ...
  describe('WorkItemPostModel', function() {
    it('should create an instance of WorkItemPostModel', function() {
      // uncomment below and update the code to test WorkItemPostModel
      //var instance = new testit_api_client.WorkItemPostModel();
      //expect(instance).to.be.a(testit_api_client.WorkItemPostModel);
    });
