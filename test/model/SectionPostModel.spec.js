...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.SectionPostModel();
  });
  ...
  describe('SectionPostModel', function() {
    it('should create an instance of SectionPostModel', function() {
      ...
      //var instance = new testit_api_client.SectionPostModel();
      //expect(instance).to.be.a(testit_api_client.SectionPostModel);
    });
