...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.SectionPostModel();
  });
  ...
  describe('SectionPostModel', function() {
    it('should create an instance of SectionPostModel', function() {
      // uncomment below and update the code to test SectionPostModel
      //var instance = new TestitApiClient.SectionPostModel();
      //expect(instance).to.be.a(TestitApiClient.SectionPostModel);
    });
