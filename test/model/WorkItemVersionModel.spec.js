...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemVersionModel();
  });
  ...
  describe('WorkItemVersionModel', function() {
    it('should create an instance of WorkItemVersionModel', function() {
      // uncomment below and update the code to test WorkItemVersionModel
      //var instance = new TestitApiClient.WorkItemVersionModel();
      //expect(instance).to.be.a(TestitApiClient.WorkItemVersionModel);
    });
