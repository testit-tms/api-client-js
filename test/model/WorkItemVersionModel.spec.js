...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.WorkItemVersionModel();
  });
  ...
  describe('WorkItemVersionModel', function() {
    it('should create an instance of WorkItemVersionModel', function() {
      ...
      //var instance = new testit_api_client.WorkItemVersionModel();
      //expect(instance).to.be.a(testit_api_client.WorkItemVersionModel);
    });
