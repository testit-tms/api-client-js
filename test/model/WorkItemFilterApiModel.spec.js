...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemFilterApiModel();
  });
  ...
  describe('WorkItemFilterApiModel', function() {
    it('should create an instance of WorkItemFilterApiModel', function() {
      // uncomment below and update the code to test WorkItemFilterApiModel
      //var instance = new TestitApiClient.WorkItemFilterApiModel();
      //expect(instance).to.be.a(TestitApiClient.WorkItemFilterApiModel);
    });
