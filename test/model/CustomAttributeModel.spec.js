...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.CustomAttributeModel();
  });
  ...
  describe('CustomAttributeModel', function() {
    it('should create an instance of CustomAttributeModel', function() {
      // uncomment below and update the code to test CustomAttributeModel
      //var instance = new TestitApiClient.CustomAttributeModel();
      //expect(instance).to.be.a(TestitApiClient.CustomAttributeModel);
    });
