...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.CustomAttributeModel();
  });
  ...
  describe('CustomAttributeModel', function() {
    it('should create an instance of CustomAttributeModel', function() {
      ...
      //var instance = new testit_api_client.CustomAttributeModel();
      //expect(instance).to.be.a(testit_api_client.CustomAttributeModel);
    });
