...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.ParameterApiResult();
  });
  ...
  describe('ParameterApiResult', function() {
    it('should create an instance of ParameterApiResult', function() {
      // uncomment below and update the code to test ParameterApiResult
      //var instance = new TestitApiClient.ParameterApiResult();
      //expect(instance).to.be.a(TestitApiClient.ParameterApiResult);
    });
