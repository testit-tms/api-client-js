...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AttachmentApiResult();
  });
  ...
  describe('AttachmentApiResult', function() {
    it('should create an instance of AttachmentApiResult', function() {
      // uncomment below and update the code to test AttachmentApiResult
      //var instance = new TestitApiClient.AttachmentApiResult();
      //expect(instance).to.be.a(TestitApiClient.AttachmentApiResult);
    });
