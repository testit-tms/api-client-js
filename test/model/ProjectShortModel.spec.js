...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.ProjectShortModel();
  });
  ...
  describe('ProjectShortModel', function() {
    it('should create an instance of ProjectShortModel', function() {
      // uncomment below and update the code to test ProjectShortModel
      //var instance = new TestitApiClient.ProjectShortModel();
      //expect(instance).to.be.a(TestitApiClient.ProjectShortModel);
    });
