...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestResultApiResult();
  });
  ...
  describe('TestResultApiResult', function() {
    it('should create an instance of TestResultApiResult', function() {
      // uncomment below and update the code to test TestResultApiResult
      //var instance = new TestitApiClient.TestResultApiResult();
      //expect(instance).to.be.a(TestitApiClient.TestResultApiResult);
    });
    ...
    it('should have the property failureClasses (base name: "failureClasses")', function() {
      // uncomment below and update the code to test the property failureClasses
      //var instance = new TestitApiClient.TestResultApiResult();
      //expect(instance).to.be();
    });
