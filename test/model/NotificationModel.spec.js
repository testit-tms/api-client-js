...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.NotificationModel();
  });
  ...
  describe('NotificationModel', function() {
    it('should create an instance of NotificationModel', function() {
      ...
      //var instance = new TestitApiClient.NotificationModel();
      //expect(instance).to.be.a(TestitApiClient.NotificationModel);
    });
