...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestResultHistoryReportApiResult();
  });
  ...
  describe('TestResultHistoryReportApiResult', function() {
    it('should create an instance of TestResultHistoryReportApiResult', function() {
      // uncomment below and update the code to test TestResultHistoryReportApiResult
      //var instance = new TestitApiClient.TestResultHistoryReportApiResult();
      //expect(instance).to.be.a(TestitApiClient.TestResultHistoryReportApiResult);
    });
