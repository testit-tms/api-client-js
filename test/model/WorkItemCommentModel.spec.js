...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemCommentModel();
  });
  ...
  describe('WorkItemCommentModel', function() {
    it('should create an instance of WorkItemCommentModel', function() {
      // uncomment below and update the code to test WorkItemCommentModel
      //var instance = new TestitApiClient.WorkItemCommentModel();
      //expect(instance).to.be.a(TestitApiClient.WorkItemCommentModel);
    });
