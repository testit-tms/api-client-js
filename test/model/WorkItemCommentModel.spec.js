...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.WorkItemCommentModel();
  });
  ...
  describe('WorkItemCommentModel', function() {
    it('should create an instance of WorkItemCommentModel', function() {
      ...
      //var instance = new testit_api_client.WorkItemCommentModel();
      //expect(instance).to.be.a(testit_api_client.WorkItemCommentModel);
    });
