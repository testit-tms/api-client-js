...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AutoTestStepResultsApiResult();
  });
  ...
  describe('AutoTestStepResultsApiResult', function() {
    it('should create an instance of AutoTestStepResultsApiResult', function() {
      // uncomment below and update the code to test AutoTestStepResultsApiResult
      //var instance = new TestitApiClient.AutoTestStepResultsApiResult();
      //expect(instance).to.be.a(TestitApiClient.AutoTestStepResultsApiResult);
    });
