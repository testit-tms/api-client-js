...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WebhooksDeleteFilterApiModel();
  });
  ...
  describe('WebhooksDeleteFilterApiModel', function() {
    it('should create an instance of WebhooksDeleteFilterApiModel', function() {
      // uncomment below and update the code to test WebhooksDeleteFilterApiModel
      //var instance = new TestitApiClient.WebhooksDeleteFilterApiModel();
      //expect(instance).to.be.a(TestitApiClient.WebhooksDeleteFilterApiModel);
    });
