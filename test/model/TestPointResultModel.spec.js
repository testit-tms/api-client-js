...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.TestPointResultModel();
  });
  ...
  describe('TestPointResultModel', function() {
    it('should create an instance of TestPointResultModel', function() {
      // uncomment below and update the code to test TestPointResultModel
      //var instance = new testit_api_client.TestPointResultModel();
      //expect(instance).to.be.a(testit_api_client.TestPointResultModel);
    });
