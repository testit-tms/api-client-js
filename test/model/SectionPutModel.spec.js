...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.SectionPutModel();
  });
  ...
  describe('SectionPutModel', function() {
    it('should create an instance of SectionPutModel', function() {
      ...
      //var instance = new testit_api_client.SectionPutModel();
      //expect(instance).to.be.a(testit_api_client.SectionPutModel);
    });
