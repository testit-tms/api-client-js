...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.SectionPutModel();
  });
  ...
  describe('SectionPutModel', function() {
    it('should create an instance of SectionPutModel', function() {
      // uncomment below and update the code to test SectionPutModel
      //var instance = new TestitApiClient.SectionPutModel();
      //expect(instance).to.be.a(TestitApiClient.SectionPutModel);
    });
