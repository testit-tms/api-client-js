...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.TestPointSelector();
  });
  ...
  describe('TestPointSelector', function() {
    it('should create an instance of TestPointSelector', function() {
      ...
      //var instance = new testit_api_client.TestPointSelector();
      //expect(instance).to.be.a(testit_api_client.TestPointSelector);
    });
