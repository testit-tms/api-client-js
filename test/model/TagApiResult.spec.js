...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TagApiResult();
  });
  ...
  describe('TagApiResult', function() {
    it('should create an instance of TagApiResult', function() {
      // uncomment below and update the code to test TagApiResult
      //var instance = new TestitApiClient.TagApiResult();
      //expect(instance).to.be.a(TestitApiClient.TagApiResult);
    });
