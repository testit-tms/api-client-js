...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.ProjectApiResult();
  });
  ...
  describe('ProjectApiResult', function() {
    it('should create an instance of ProjectApiResult', function() {
      // uncomment below and update the code to test ProjectApiResult
      //var instance = new TestitApiClient.ProjectApiResult();
      //expect(instance).to.be.a(TestitApiClient.ProjectApiResult);
    });
