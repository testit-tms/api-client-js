...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AutoTestUpdateApiModel();
  });
  ...
  describe('AutoTestUpdateApiModel', function() {
    it('should create an instance of AutoTestUpdateApiModel', function() {
      // uncomment below and update the code to test AutoTestUpdateApiModel
      //var instance = new TestitApiClient.AutoTestUpdateApiModel();
      //expect(instance).to.be.a(TestitApiClient.AutoTestUpdateApiModel);
    });
