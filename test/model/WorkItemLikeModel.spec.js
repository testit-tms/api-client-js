...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.WorkItemLikeModel();
  });
  ...
  describe('WorkItemLikeModel', function() {
    it('should create an instance of WorkItemLikeModel', function() {
      ...
      //var instance = new testit_api_client.WorkItemLikeModel();
      //expect(instance).to.be.a(testit_api_client.WorkItemLikeModel);
    });
