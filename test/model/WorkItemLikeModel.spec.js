...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemLikeModel();
  });
  ...
  describe('WorkItemLikeModel', function() {
    it('should create an instance of WorkItemLikeModel', function() {
      // uncomment below and update the code to test WorkItemLikeModel
      //var instance = new TestitApiClient.WorkItemLikeModel();
      //expect(instance).to.be.a(TestitApiClient.WorkItemLikeModel);
    });
