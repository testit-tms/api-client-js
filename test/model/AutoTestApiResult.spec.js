...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AutoTestApiResult();
  });
  ...
  describe('AutoTestApiResult', function() {
    it('should create an instance of AutoTestApiResult', function() {
      // uncomment below and update the code to test AutoTestApiResult
      //var instance = new TestitApiClient.AutoTestApiResult();
      //expect(instance).to.be.a(TestitApiClient.AutoTestApiResult);
    });
