...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.SectionWithStepsModel();
  });
  ...
  describe('SectionWithStepsModel', function() {
    it('should create an instance of SectionWithStepsModel', function() {
      // uncomment below and update the code to test SectionWithStepsModel
      //var instance = new TestitApiClient.SectionWithStepsModel();
      //expect(instance).to.be.a(TestitApiClient.SectionWithStepsModel);
    });
