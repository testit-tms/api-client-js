...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestRunV2ApiResult();
  });
  ...
  describe('TestRunV2ApiResult', function() {
    it('should create an instance of TestRunV2ApiResult', function() {
      // uncomment below and update the code to test TestRunV2ApiResult
      //var instance = new TestitApiClient.TestRunV2ApiResult();
      //expect(instance).to.be.a(TestitApiClient.TestRunV2ApiResult);
    });
