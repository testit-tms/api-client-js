...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.AutoTestPutModel();
  });
  ...
  describe('AutoTestPutModel', function() {
    it('should create an instance of AutoTestPutModel', function() {
      // uncomment below and update the code to test AutoTestPutModel
      //var instance = new testit_api_client.AutoTestPutModel();
      //expect(instance).to.be.a(testit_api_client.AutoTestPutModel);
    });
