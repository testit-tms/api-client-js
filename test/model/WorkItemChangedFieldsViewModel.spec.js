...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemChangedFieldsViewModel();
  });
  ...
  describe('WorkItemChangedFieldsViewModel', function() {
    it('should create an instance of WorkItemChangedFieldsViewModel', function() {
      // uncomment below and update the code to test WorkItemChangedFieldsViewModel
      //var instance = new TestitApiClient.WorkItemChangedFieldsViewModel();
      //expect(instance).to.be.a(TestitApiClient.WorkItemChangedFieldsViewModel);
    });
