...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestResultV2GetModel();
  });
  ...
  describe('TestResultV2GetModel', function() {
    it('should create an instance of TestResultV2GetModel', function() {
      ...
      //var instance = new TestitApiClient.TestResultV2GetModel();
      //expect(instance).to.be.a(TestitApiClient.TestResultV2GetModel);
    });
