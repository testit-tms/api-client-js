...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.WorkItemShortModel();
  });
  ...
  describe('WorkItemShortModel', function() {
    it('should create an instance of WorkItemShortModel', function() {
      // uncomment below and update the code to test WorkItemShortModel
      //var instance = new TestitApiClient.WorkItemShortModel();
      //expect(instance).to.be.a(TestitApiClient.WorkItemShortModel);
    });
