...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.WorkItemShortModel();
  });
  ...
  describe('WorkItemShortModel', function() {
    it('should create an instance of WorkItemShortModel', function() {
      ...
      //var instance = new testit_api_client.WorkItemShortModel();
      //expect(instance).to.be.a(testit_api_client.WorkItemShortModel);
    });
