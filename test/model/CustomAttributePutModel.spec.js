...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.CustomAttributePutModel();
  });
  ...
  describe('CustomAttributePutModel', function() {
    it('should create an instance of CustomAttributePutModel', function() {
      // uncomment below and update the code to test CustomAttributePutModel
      //var instance = new TestitApiClient.CustomAttributePutModel();
      //expect(instance).to.be.a(TestitApiClient.CustomAttributePutModel);
    });
