...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestPlanApiResult();
  });
  ...
  describe('TestPlanApiResult', function() {
    it('should create an instance of TestPlanApiResult', function() {
      // uncomment below and update the code to test TestPlanApiResult
      //var instance = new TestitApiClient.TestPlanApiResult();
      //expect(instance).to.be.a(TestitApiClient.TestPlanApiResult);
    });
