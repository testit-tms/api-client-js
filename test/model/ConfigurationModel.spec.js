...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.ConfigurationModel();
  });
  ...
  describe('ConfigurationModel', function() {
    it('should create an instance of ConfigurationModel', function() {
      // uncomment below and update the code to test ConfigurationModel
      //var instance = new TestitApiClient.ConfigurationModel();
      //expect(instance).to.be.a(TestitApiClient.ConfigurationModel);
    });
