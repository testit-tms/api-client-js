...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.AutoTestPostModel();
  });
  ...
  describe('AutoTestPostModel', function() {
    it('should create an instance of AutoTestPostModel', function() {
      // uncomment below and update the code to test AutoTestPostModel
      //var instance = new testit_api_client.AutoTestPostModel();
      //expect(instance).to.be.a(testit_api_client.AutoTestPostModel);
    });
