...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AttachmentModel();
  });
  ...
  describe('AttachmentModel', function() {
    it('should create an instance of AttachmentModel', function() {
      // uncomment below and update the code to test AttachmentModel
      //var instance = new TestitApiClient.AttachmentModel();
      //expect(instance).to.be.a(TestitApiClient.AttachmentModel);
    });
