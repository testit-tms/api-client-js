...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.AttachmentModel();
  });
  ...
  describe('AttachmentModel', function() {
    it('should create an instance of AttachmentModel', function() {
      ...
      //var instance = new testit_api_client.AttachmentModel();
      //expect(instance).to.be.a(testit_api_client.AttachmentModel);
    });
