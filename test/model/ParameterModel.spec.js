...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.ParameterModel();
  });
  ...
  describe('ParameterModel', function() {
    it('should create an instance of ParameterModel', function() {
      // uncomment below and update the code to test ParameterModel
      //var instance = new testit_api_client.ParameterModel();
      //expect(instance).to.be.a(testit_api_client.ParameterModel);
    });
