...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.TestPlanWithAnalyticModel();
  });
  ...
  describe('TestPlanWithAnalyticModel', function() {
    it('should create an instance of TestPlanWithAnalyticModel', function() {
      // uncomment below and update the code to test TestPlanWithAnalyticModel
      //var instance = new TestitApiClient.TestPlanWithAnalyticModel();
      //expect(instance).to.be.a(TestitApiClient.TestPlanWithAnalyticModel);
    });
