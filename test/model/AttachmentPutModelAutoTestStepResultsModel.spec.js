...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.AttachmentPutModelAutoTestStepResultsModel();
  });
  ...
  describe('AttachmentPutModelAutoTestStepResultsModel', function() {
    it('should create an instance of AttachmentPutModelAutoTestStepResultsModel', function() {
      // uncomment below and update the code to test AttachmentPutModelAutoTestStepResultsModel
      //var instance = new TestitApiClient.AttachmentPutModelAutoTestStepResultsModel();
      //expect(instance).to.be.a(TestitApiClient.AttachmentPutModelAutoTestStepResultsModel);
    });
