...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.AttachmentPutModelAutoTestStepResultsModel();
  });
  ...
  describe('AttachmentPutModelAutoTestStepResultsModel', function() {
    it('should create an instance of AttachmentPutModelAutoTestStepResultsModel', function() {
      ...
      //var instance = new testit_api_client.AttachmentPutModelAutoTestStepResultsModel();
      //expect(instance).to.be.a(testit_api_client.AttachmentPutModelAutoTestStepResultsModel);
    });
