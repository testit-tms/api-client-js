...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.ProblemDetails();
  });
  ...
  describe('ProblemDetails', function() {
    it('should create an instance of ProblemDetails', function() {
      ...
      //var instance = new testit_api_client.ProblemDetails();
      //expect(instance).to.be.a(testit_api_client.ProblemDetails);
    });
