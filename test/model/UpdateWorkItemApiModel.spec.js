...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.UpdateWorkItemApiModel();
  });
  ...
  describe('UpdateWorkItemApiModel', function() {
    it('should create an instance of UpdateWorkItemApiModel', function() {
      // uncomment below and update the code to test UpdateWorkItemApiModel
      //var instance = new TestitApiClient.UpdateWorkItemApiModel();
      //expect(instance).to.be.a(TestitApiClient.UpdateWorkItemApiModel);
    });
