...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.StepCommentModel();
  });
  ...
  describe('StepCommentModel', function() {
    it('should create an instance of StepCommentModel', function() {
      // uncomment below and update the code to test StepCommentModel
      //var instance = new testit_api_client.StepCommentModel();
      //expect(instance).to.be.a(testit_api_client.StepCommentModel);
    });
