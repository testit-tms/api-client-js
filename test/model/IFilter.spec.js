...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.IFilter();
  });
  ...
  describe('IFilter', function() {
    it('should create an instance of IFilter', function() {
      // uncomment below and update the code to test IFilter
      //var instance = new TestitApiClient.IFilter();
      //expect(instance).to.be.a(TestitApiClient.IFilter);
    });
