...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new testit_api_client.NoContentResult();
  });
  ...
  describe('NoContentResult', function() {
    it('should create an instance of NoContentResult', function() {
      ...
      //var instance = new testit_api_client.NoContentResult();
      //expect(instance).to.be.a(testit_api_client.NoContentResult);
    });
