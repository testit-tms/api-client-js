...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestitApiClient.SectionsApi();
  });
  ...
  describe('SectionsApi', function() {
    describe('apiV2SectionsIdPatch', function() {
      it('should call apiV2SectionsIdPatch successfully', function(done) {
        //uncomment below and update the code to test apiV2SectionsIdPatch
        //instance.apiV2SectionsIdPatch(function(error) {
