...
declare class ConfigurationPostModel {
     ...
     */
    static initialize(obj: any, parameters: any, projectId: any, isDefault: any, name: any): void;
    /**
     ...
     * @param name {String}
     */
    constructor(parameters: any, projectId: string, isDefault: boolean, name: string);
    description: any;
    parameters: any;
    projectId: any;
    isDefault: any;
...
declare namespace ConfigurationPostModel {
