 ...
 */
declare class ExternalIssueApiType {
    /**
    ...
    /**
     * Constructs a <code>ExternalIssueApiType</code> from a plain JavaScript object, optionally creating a new instance.
     ...
     * @param name {String} Name of external issue type
     */
    constructor(name: string);
    name: any;
    iconUrl: any;
}
declare namespace ExternalIssueApiType {
