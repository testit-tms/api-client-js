...
class ProjectShortestModel {
    ...
    constructor(id, isDeleted, globalId, name, type) { 
        ...
        ProjectShortestModel.initialize(this, id, isDeleted, globalId, name, type);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ProjectShortestModel.RequiredProperties) {
...
ProjectShortestModel.RequiredProperties = ["id", "isDeleted", "globalId", "name", "type"];
 ...
 */
ProjectShortestModel.prototype['type'] = undefined;
