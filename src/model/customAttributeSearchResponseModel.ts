...
export class CustomAttributeSearchResponseModel {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "workItemUsage",
            "baseName": "workItemUsage",
            "type": "Array<ProjectShortestModel>"
        },
        {
            "name": "testPlanUsage",
            "baseName": "testPlanUsage",
            "type": "Array<ProjectShortestModel>"
        },
        {
            "name": "id",
    ...
    static getAttributeTypeMap() {
        return CustomAttributeSearchResponseModel.attributeTypeMap;
    }
}

export namespace CustomAttributeSearchResponseModel {
}
