...
class TestResultsLocalFilterModel {
    /**
     * Constructs a new <code>TestResultsLocalFilterModel</code>.
     * @alias module:model/TestResultsLocalFilterModel
     */
    constructor() { 
        
        TestResultsLocalFilterModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestResultsLocalFilterModel();
