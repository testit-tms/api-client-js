...
class TestRunStatisticsFilterApiModel {
    /**
     * Constructs a new <code>TestRunStatisticsFilterApiModel</code>.
     * @alias module:model/TestRunStatisticsFilterApiModel
     */
    constructor() { 
        
        TestRunStatisticsFilterApiModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestRunStatisticsFilterApiModel();
