...
class ConfigurationPutModel {
     ...
     * @param name {String} 
     */
    constructor(id, parameters, projectId, isDefault, name) { 
        
        ConfigurationPutModel.initialize(this, id, parameters, projectId, isDefault, name);
    }
     ...
     */
    static initialize(obj, id, parameters, projectId, isDefault, name) { 
        obj['id'] = id;
    ...
    static validateJSON(data) {
        ...
        for (const property of ConfigurationPutModel.RequiredProperties) {
...
ConfigurationPutModel.RequiredProperties = ["id", "parameters", "projectId", "isDefault", "name"];
 ...
 */
ConfigurationPutModel.prototype['parameters'] = undefined;
