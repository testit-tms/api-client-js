...
class SearchWebhooksQueryModel {
    /**
     * Constructs a new <code>SearchWebhooksQueryModel</code>.
     * @alias module:model/SearchWebhooksQueryModel
     */
    constructor() { 
        
        SearchWebhooksQueryModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SearchWebhooksQueryModel();

            if (data.hasOwnProperty('name')) {
                obj['name'] = ApiClient.convertToType(data['name'], 'String');
            }
            if (data.hasOwnProperty('eventTypes')) {
                obj['eventTypes'] = ApiClient.convertToType(data['eventTypes'], [WebHookEventTypeModel]);
            }
            if (data.hasOwnProperty('methods')) {
                obj['methods'] = ApiClient.convertToType(data['methods'], [RequestTypeModel]);
            }
 ...
 * @member {String} name
 */
SearchWebhooksQueryModel.prototype['name'] = undefined;

/**
 * Specifies a webhook event types to search for
 * @member {Array.<module:model/WebHookEventTypeModel>} eventTypes
 */
SearchWebhooksQueryModel.prototype['eventTypes'] = undefined;

/**
 * Specifies a webhook methods to search for
 * @member {Array.<module:model/RequestTypeModel>} methods
 */
SearchWebhooksQueryModel.prototype['methods'] = undefined;

/**
 * Specifies a webhook project IDs to search for
 * @member {Array.<String>} projectIds
 */
SearchWebhooksQueryModel.prototype['projectIds'] = undefined;

/**
 * Specifies a webhook deleted status to search for
 * @member {Boolean} isEnabled
 */
SearchWebhooksQueryModel.prototype['isEnabled'] = undefined;
