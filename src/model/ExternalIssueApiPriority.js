...
class ExternalIssueApiPriority {
    ...
    constructor(name) { 
        ...
        ExternalIssueApiPriority.initialize(this, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExternalIssueApiPriority();
    ...
    static validateJSON(data) {
        ...
        for (const property of ExternalIssueApiPriority.RequiredProperties) {
...
ExternalIssueApiPriority.RequiredProperties = ["name"];

/**
 * Name of external issue priority
 * @member {String} name
 */
ExternalIssueApiPriority.prototype['name'] = undefined;

/**
 * Url to the icon of external issue priority
 * @member {String} iconUrl
 */
ExternalIssueApiPriority.prototype['iconUrl'] = undefined;
