...
class WorkItemParameterKeyModel {
    ...
    constructor(id) { 
        ...
        WorkItemParameterKeyModel.initialize(this, id);
    }
    ...
    /**
     * Constructs a <code>WorkItemParameterKeyModel</code> from a plain JavaScript object, optionally creating a new instance.
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkItemParameterKeyModel();
    ...
    static validateJSON(data) {
        ...
        for (const property of WorkItemParameterKeyModel.RequiredProperties) {
...
WorkItemParameterKeyModel.RequiredProperties = ["id"];

/**
 * @member {String} id
 */
WorkItemParameterKeyModel.prototype['id'] = undefined;
...
export default WorkItemParameterKeyModel;
