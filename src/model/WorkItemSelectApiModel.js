...
class WorkItemSelectApiModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('extractionModel')) {
                obj['extractionModel'] = ApiClient.convertToType(data['extractionModel'], WorkItemExtractionApiModel);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        if (data['extractionModel']) { // data not null
          WorkItemExtractionApiModel.validateJSON(data['extractionModel']);
        }
...
/**
 * @member {module:model/WorkItemExtractionApiModel} extractionModel
 */
WorkItemSelectApiModel.prototype['extractionModel'] = undefined;
