...
class StringExtractionModel {
    /**
     * Constructs a new <code>StringExtractionModel</code>.
     * @alias module:model/StringExtractionModel
     */
    constructor() { 
        
        StringExtractionModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StringExtractionModel();
 ...
 */
StringExtractionModel.prototype['include'] = undefined;

/**
 * @member {Array.<String>} exclude
 */
StringExtractionModel.prototype['exclude'] = undefined;
