...
class TestSuiteV2PostModel {
     ...
     */
    constructor(testPlanId, name) { 
        
        TestSuiteV2PostModel.initialize(this, testPlanId, name);
    }
     ...
     */
    static initialize(obj, testPlanId, name) { 
    ...
    static validateJSON(data) {
        ...
        for (const property of TestSuiteV2PostModel.RequiredProperties) {
...
TestSuiteV2PostModel.RequiredProperties = ["testPlanId", "name"];
