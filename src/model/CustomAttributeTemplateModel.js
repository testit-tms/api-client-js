...
class CustomAttributeTemplateModel {
     ...
     */
    constructor(id, isDeleted, name) { 
        
        CustomAttributeTemplateModel.initialize(this, id, isDeleted, name);
    }
     ...
     */
    static initialize(obj, id, isDeleted, name) { 
        obj['id'] = id;
    ...
    static validateJSON(data) {
        ...
        for (const property of CustomAttributeTemplateModel.RequiredProperties) {
...
CustomAttributeTemplateModel.RequiredProperties = ["id", "isDeleted", "name"];
