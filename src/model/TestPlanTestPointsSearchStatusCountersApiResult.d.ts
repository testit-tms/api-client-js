 ...
 */
declare class TestPlanTestPointsSearchStatusCountersApiResult {
    /**
     * Initializes the fields of this object.
     * This method is used by the constructors of any subclasses, in order to implement multiple inheritance (mix-ins).
     * Only for internal use.
     */
    static initialize(obj: any, automatedTestPointsCount: any, automatedTestPointsInProgressCount: any, automatedTestPointsFailedCount: any, manualTestPointsCount: any): void;
    /**
     ...
     */
    constructor(automatedTestPointsCount: number, automatedTestPointsInProgressCount: number, automatedTestPointsFailedCount: number, manualTestPointsCount: number);
    automatedTestPointsCount: any;
    automatedTestPointsInProgressCount: any;
    automatedTestPointsFailedCount: any;
    manualTestPointsCount: any;
}
declare namespace TestPlanTestPointsSearchStatusCountersApiResult {
