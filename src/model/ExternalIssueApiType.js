...
class ExternalIssueApiType {
    ...
    constructor(name) { 
        ...
        ExternalIssueApiType.initialize(this, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ExternalIssueApiType();
    ...
    static validateJSON(data) {
        ...
        for (const property of ExternalIssueApiType.RequiredProperties) {
...
ExternalIssueApiType.RequiredProperties = ["name"];

/**
 * Name of external issue type
 * @member {String} name
 */
ExternalIssueApiType.prototype['name'] = undefined;

/**
 * Url to the icon of external issue type
 * @member {String} iconUrl
 */
ExternalIssueApiType.prototype['iconUrl'] = undefined;
