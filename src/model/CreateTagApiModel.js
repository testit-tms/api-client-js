...
class CreateTagApiModel {
    ...
    constructor(name) { 
        ...
        CreateTagApiModel.initialize(this, name);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateTagApiModel.RequiredProperties) {
...
CreateTagApiModel.RequiredProperties = ["name"];

/**
 * Name of the tag
 * @member {String} name
 */
CreateTagApiModel.prototype['name'] = undefined;
