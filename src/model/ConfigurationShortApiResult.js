...
class ConfigurationShortApiResult {
    ...
    constructor(id, name) { 
        ...
        ConfigurationShortApiResult.initialize(this, id, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ConfigurationShortApiResult();
    ...
    static validateJSON(data) {
        ...
        for (const property of ConfigurationShortApiResult.RequiredProperties) {
