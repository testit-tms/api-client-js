...
class TestResultV2GetModel {
    ...
    constructor(id, configurationId, workItemVersionId, testRunId, outcome) { 
        ...
        TestResultV2GetModel.initialize(this, id, configurationId, workItemVersionId, testRunId, outcome);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('configuration')) {
                obj['configuration'] = ApiClient.convertToType(data['configuration'], ConfigurationModel);
            }
            if (data.hasOwnProperty('autoTest')) {
                obj['autoTest'] = ApiClient.convertToType(data['autoTest'], AutoTestModelV2GetModel);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of TestResultV2GetModel.RequiredProperties) {
        ...
        if (data['configuration']) { // data not null
          ConfigurationModel.validateJSON(data['configuration']);
        }
        // validate the optional field `autoTest`
        if (data['autoTest']) { // data not null
          AutoTestModelV2GetModel.validateJSON(data['autoTest']);
        }
...
TestResultV2GetModel.RequiredProperties = ["id", "configurationId", "workItemVersionId", "testRunId", "outcome"];
