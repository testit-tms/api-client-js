...
class SectionRenameModel {
    ...
    constructor(id, name) { 
        ...
        SectionRenameModel.initialize(this, id, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SectionRenameModel();
    ...
    static validateJSON(data) {
        ...
        for (const property of SectionRenameModel.RequiredProperties) {
...
SectionRenameModel.RequiredProperties = ["id", "name"];

/**
 * @member {String} id
 */
SectionRenameModel.prototype['id'] = undefined;

/**
 * @member {String} name
 */
SectionRenameModel.prototype['name'] = undefined;
