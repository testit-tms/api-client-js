...
class UpdateTagApiModel {
    ...
    constructor(name) { 
        ...
        UpdateTagApiModel.initialize(this, name);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of UpdateTagApiModel.RequiredProperties) {
...
UpdateTagApiModel.RequiredProperties = ["name"];

/**
 * Name of the tag
 * @member {String} name
 */
UpdateTagApiModel.prototype['name'] = undefined;
