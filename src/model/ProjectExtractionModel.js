...
class ProjectExtractionModel {
    /**
     * Constructs a new <code>ProjectExtractionModel</code>.
     * @alias module:model/ProjectExtractionModel
     */
    constructor() { 
        
        ProjectExtractionModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectExtractionModel();
 ...
 */
ProjectExtractionModel.prototype['ids'] = undefined;
