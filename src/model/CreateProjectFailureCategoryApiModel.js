...
class CreateProjectFailureCategoryApiModel {
    ...
    constructor(name, failureCategory) { 
        ...
        CreateProjectFailureCategoryApiModel.initialize(this, name, failureCategory);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateProjectFailureCategoryApiModel();
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateProjectFailureCategoryApiModel.RequiredProperties) {
...
CreateProjectFailureCategoryApiModel.RequiredProperties = ["name", "failureCategory"];

/**
 * Failure category name
 * @member {String} name
 */
CreateProjectFailureCategoryApiModel.prototype['name'] = undefined;

/**
 * Category type
 * @member {module:model/FailureCategory} failureCategory
 */
CreateProjectFailureCategoryApiModel.prototype['failureCategory'] = undefined;

/**
 * Failure category regexes
 * @member {Array.<module:model/CreateFailureClassRegexApiModel>} failureClassRegexes
 */
CreateProjectFailureCategoryApiModel.prototype['failureClassRegexes'] = undefined;
