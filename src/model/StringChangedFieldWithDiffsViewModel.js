...
class StringChangedFieldWithDiffsViewModel {
    /**
     * Constructs a new <code>StringChangedFieldWithDiffsViewModel</code>.
     * @alias module:model/StringChangedFieldWithDiffsViewModel
     */
    constructor() { 
        
        StringChangedFieldWithDiffsViewModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StringChangedFieldWithDiffsViewModel();

            if (data.hasOwnProperty('diffValue')) {
                obj['diffValue'] = ApiClient.convertToType(data['diffValue'], 'String');
            }
    ...
    static validateJSON(data) {
        ...
        if (data['diffValue'] && !(typeof data['diffValue'] === 'string' || data['diffValue'] instanceof String)) {
            throw new Error("Expected the field `diffValue` to be a primitive type in the JSON string but got " + data['diffValue']);
        }
        // ensure the json data is a string
...
/**
 * @member {String} diffValue
 */
StringChangedFieldWithDiffsViewModel.prototype['diffValue'] = undefined;

/**
 * @member {String} oldValue
 */
StringChangedFieldWithDiffsViewModel.prototype['oldValue'] = undefined;

/**
 * @member {String} newValue
 */
StringChangedFieldWithDiffsViewModel.prototype['newValue'] = undefined;
