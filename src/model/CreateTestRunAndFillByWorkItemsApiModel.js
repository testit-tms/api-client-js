...
class CreateTestRunAndFillByWorkItemsApiModel {
     ...
     */
    constructor(projectId, testPlanId, configurationIds, workItemIds) { 
        
        CreateTestRunAndFillByWorkItemsApiModel.initialize(this, projectId, testPlanId, configurationIds, workItemIds);
    }
     ...
     */
    static initialize(obj, projectId, testPlanId, configurationIds, workItemIds) { 
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new CreateTestRunAndFillByWorkItemsApiModel();
    ...
    static validateJSON(data) {
        ...
        for (const property of CreateTestRunAndFillByWorkItemsApiModel.RequiredProperties) {
...
CreateTestRunAndFillByWorkItemsApiModel.RequiredProperties = ["projectId", "testPlanId", "configurationIds", "workItemIds"];

/**
 * Specifies the GUID of the project, in which a test run will be created.
 * @member {String} projectId
 */
CreateTestRunAndFillByWorkItemsApiModel.prototype['projectId'] = undefined;

/**
 * Specifies the GUID of the test plan, within which the test run will be created.
 * @member {String} testPlanId
 */
CreateTestRunAndFillByWorkItemsApiModel.prototype['testPlanId'] = undefined;

/**
 * Specifies the name of the test run.
 * @member {String} name
 */
CreateTestRunAndFillByWorkItemsApiModel.prototype['name'] = undefined;

/**
 * Specifies the test run description.
 * @member {String} description
 */
CreateTestRunAndFillByWorkItemsApiModel.prototype['description'] = undefined;

/**
 * Specifies the test run launch source.
 * @member {String} launchSource
 */
CreateTestRunAndFillByWorkItemsApiModel.prototype['launchSource'] = undefined;

/**
 * Collection of attachment ids to relate to the test run
 * @member {Array.<module:model/AssignAttachmentApiModel>} attachments
 */
CreateTestRunAndFillByWorkItemsApiModel.prototype['attachments'] = undefined;
 ...
 */
CreateTestRunAndFillByWorkItemsApiModel.prototype['configurationIds'] = undefined;
