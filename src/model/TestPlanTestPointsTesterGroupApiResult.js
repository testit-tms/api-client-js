...
class TestPlanTestPointsTesterGroupApiResult {
    ...
    constructor(userId, value) { 
        ...
        TestPlanTestPointsTesterGroupApiResult.initialize(this, userId, value);
    }
     ...
     */
    static initialize(obj, userId, value) { 
        obj['userId'] = userId;
        obj['value'] = value;
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestPlanTestPointsTesterGroupApiResult();
    ...
    static validateJSON(data) {
        ...
        for (const property of TestPlanTestPointsTesterGroupApiResult.RequiredProperties) {
...
TestPlanTestPointsTesterGroupApiResult.RequiredProperties = ["userId", "value"];

/**
 * @member {String} userId
 */
TestPlanTestPointsTesterGroupApiResult.prototype['userId'] = undefined;

/**
 * @member {Number} value
 */
TestPlanTestPointsTesterGroupApiResult.prototype['value'] = undefined;
