...
class GuidNullableChangedFieldViewModel {
    /**
     * Constructs a new <code>GuidNullableChangedFieldViewModel</code>.
     * @alias module:model/GuidNullableChangedFieldViewModel
     */
    constructor() { 
        
        GuidNullableChangedFieldViewModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GuidNullableChangedFieldViewModel();
 ...
 */
GuidNullableChangedFieldViewModel.prototype['oldValue'] = undefined;

/**
 * @member {String} newValue
 */
GuidNullableChangedFieldViewModel.prototype['newValue'] = undefined;
