 ...
 * @member {Date} date
 */
TestResultShortResponse.prototype['date'] = undefined;

/**
 * Date when the test result has been created
 * @member {Date} createdDate
 */
TestResultShortResponse.prototype['createdDate'] = undefined;

/**
 * Date when the test result has been modified
 * @member {Date} modifiedDate
 */
TestResultShortResponse.prototype['modifiedDate'] = undefined;

/**
 * Date when the test result has been started
 * @member {Date} startedOn
 */
TestResultShortResponse.prototype['startedOn'] = undefined;

/**
 * Date when the test result has been completed
 * @member {Date} completedOn
 */
TestResultShortResponse.prototype['completedOn'] = undefined;
