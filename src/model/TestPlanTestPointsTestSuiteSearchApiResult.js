...
class TestPlanTestPointsTestSuiteSearchApiResult {
    ...
    constructor(id, name) { 
        ...
        TestPlanTestPointsTestSuiteSearchApiResult.initialize(this, id, name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestPlanTestPointsTestSuiteSearchApiResult();
    ...
    static validateJSON(data) {
        ...
        for (const property of TestPlanTestPointsTestSuiteSearchApiResult.RequiredProperties) {
...
TestPlanTestPointsTestSuiteSearchApiResult.RequiredProperties = ["id", "name"];

/**
 * @member {String} id
 */
TestPlanTestPointsTestSuiteSearchApiResult.prototype['id'] = undefined;

/**
 * @member {String} name
 */
TestPlanTestPointsTestSuiteSearchApiResult.prototype['name'] = undefined;
