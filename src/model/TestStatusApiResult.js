...
class TestStatusApiResult {
    ...
    constructor(id, name, type, isSystem, code) { 
        ...
        TestStatusApiResult.initialize(this, id, name, type, isSystem, code);
    }
...
TestStatusApiResult.RequiredProperties = ["id", "name", "type", "isSystem", "code"];
 ...
 * @member {String} name
 */
TestStatusApiResult.prototype['name'] = undefined;
 ...
 */
TestStatusApiResult.prototype['isSystem'] = undefined;
 ...
 */
TestStatusApiResult.prototype['description'] = undefined;
