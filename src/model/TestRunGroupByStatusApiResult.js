...
class TestRunGroupByStatusApiResult {
    ...
    constructor(status, value) { 
        ...
        TestRunGroupByStatusApiResult.initialize(this, status, value);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TestRunGroupByStatusApiResult();
    ...
    static validateJSON(data) {
        ...
        for (const property of TestRunGroupByStatusApiResult.RequiredProperties) {
...
TestRunGroupByStatusApiResult.RequiredProperties = ["status", "value"];

/**
 * @member {String} status
 */
TestRunGroupByStatusApiResult.prototype['status'] = undefined;

/**
 * @member {Number} value
 */
TestRunGroupByStatusApiResult.prototype['value'] = undefined;
