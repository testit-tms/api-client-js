...
class DetailedProjectApiResult {
    ...
    constructor(id, name, isFavorite, workItemsCount, isDeleted, createdDate, createdById, globalId, type, workflowId) { 
        ...
        DetailedProjectApiResult.initialize(this, id, name, isFavorite, workItemsCount, isDeleted, createdDate, createdById, globalId, type, workflowId);
    }
...
DetailedProjectApiResult.RequiredProperties = ["id", "name", "isFavorite", "workItemsCount", "isDeleted", "createdDate", "createdById", "globalId", "type", "workflowId"];
 ...
 */
DetailedProjectApiResult.prototype['testPlansAttributesScheme'] = undefined;
 ...
 */
DetailedProjectApiResult.prototype['workItemsCount'] = undefined;

/**
 * Number of test cases in the project
 * @member {Number} testCasesCount
 */
DetailedProjectApiResult.prototype['testCasesCount'] = undefined;

/**
 * Number of shared steps in the project
 * @member {Number} sharedStepsCount
 */
DetailedProjectApiResult.prototype['sharedStepsCount'] = undefined;

/**
 * Number of checklists in the project
 * @member {Number} checkListsCount
 */
DetailedProjectApiResult.prototype['checkListsCount'] = undefined;

/**
 * Number of autotests in the project
 * @member {Number} autoTestsCount
 */
DetailedProjectApiResult.prototype['autoTestsCount'] = undefined;
 ...
 */
DetailedProjectApiResult.prototype['createdDate'] = undefined;

/**
 * Last modification date of the project
 * @member {Date} modifiedDate
 */
DetailedProjectApiResult.prototype['modifiedDate'] = undefined;

/**
 * Unique ID of the project creator
 * @member {String} createdById
 */
DetailedProjectApiResult.prototype['createdById'] = undefined;

/**
 * Unique ID of the project last editor
 * @member {String} modifiedById
 */
DetailedProjectApiResult.prototype['modifiedById'] = undefined;
 ...
 */
DetailedProjectApiResult.prototype['type'] = undefined;
