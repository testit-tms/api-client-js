...
class ParameterApiResult {
     ...
     */
    constructor(id, parameterKeyId, name, value, createdDate, createdById, isDeleted, projectIds) { 
        
        ParameterApiResult.initialize(this, id, parameterKeyId, name, value, createdDate, createdById, isDeleted, projectIds);
    }
     ...
     */
    static initialize(obj, id, parameterKeyId, name, value, createdDate, createdById, isDeleted, projectIds) { 
        obj['id'] = id;
...
ParameterApiResult.RequiredProperties = ["id", "parameterKeyId", "name", "value", "createdDate", "createdById", "isDeleted", "projectIds"];
 ...
 */
ParameterApiResult.prototype['createdDate'] = undefined;

/**
 * @member {String} createdById
 */
ParameterApiResult.prototype['createdById'] = undefined;

/**
 * @member {Date} modifiedDate
 */
ParameterApiResult.prototype['modifiedDate'] = undefined;

/**
 * @member {String} modifiedById
 */
ParameterApiResult.prototype['modifiedById'] = undefined;
