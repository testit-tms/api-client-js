...
class LastTestResultModel {
     ...
     */
    constructor(id, testRunId, workItemVersionId) { 
        
        LastTestResultModel.initialize(this, id, testRunId, workItemVersionId);
    }
     ...
     */
    static initialize(obj, id, testRunId, workItemVersionId) { 
        obj['id'] = id;
    ...
    static validateJSON(data) {
        ...
        for (const property of LastTestResultModel.RequiredProperties) {
...
LastTestResultModel.RequiredProperties = ["id", "testRunId", "workItemVersionId"];
