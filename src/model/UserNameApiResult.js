...
class UserNameApiResult {
    ...
    constructor(id) { 
        ...
        UserNameApiResult.initialize(this, id);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of UserNameApiResult.RequiredProperties) {
...
UserNameApiResult.RequiredProperties = ["id"];

/**
 * @member {String} id
 */
UserNameApiResult.prototype['id'] = undefined;

/**
 * @member {String} name
 */
UserNameApiResult.prototype['name'] = undefined;
