...
class TagShortApiResult {
    ...
    constructor(name) { 
        ...
        TagShortApiResult.initialize(this, name);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of TagShortApiResult.RequiredProperties) {
...
TagShortApiResult.RequiredProperties = ["name"];

/**
 * Name of the tag
 * @member {String} name
 */
TagShortApiResult.prototype['name'] = undefined;
