...
class ProjectModel {
    ...
    constructor(id, name, isFavorite, isDeleted, createdDate, createdById, globalId, type, workflowId) { 
        ...
        ProjectModel.initialize(this, id, name, isFavorite, isDeleted, createdDate, createdById, globalId, type, workflowId);
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ProjectModel.RequiredProperties) {
...
ProjectModel.RequiredProperties = ["id", "name", "isFavorite", "isDeleted", "createdDate", "createdById", "globalId", "type", "workflowId"];
