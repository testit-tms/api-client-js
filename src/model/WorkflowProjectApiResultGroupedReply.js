...
class WorkflowProjectApiResultGroupedReply {
    ...
    constructor(groups, totalCount) { 
        ...
        WorkflowProjectApiResultGroupedReply.initialize(this, groups, totalCount);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WorkflowProjectApiResultGroupedReply();

            if (data.hasOwnProperty('groups')) {
                obj['groups'] = ApiClient.convertToType(data['groups'], [WorkflowProjectApiResultGroup]);
            }
    ...
    static validateJSON(data) {
        ...
        for (const property of WorkflowProjectApiResultGroupedReply.RequiredProperties) {
        ...
        if (data['groups']) { // data not null
            ...
            for (const item of data['groups']) {
                WorkflowProjectApiResultGroup.validateJSON(item);
            };
        }
...
WorkflowProjectApiResultGroupedReply.RequiredProperties = ["groups", "totalCount"];

/**
 * @member {Array.<module:model/WorkflowProjectApiResultGroup>} groups
 */
WorkflowProjectApiResultGroupedReply.prototype['groups'] = undefined;

/**
 * @member {Number} totalCount
 */
WorkflowProjectApiResultGroupedReply.prototype['totalCount'] = undefined;
