...
class GetAIServiceModelsApiModel {
    /**
     * Constructs a new <code>GetAIServiceModelsApiModel</code>.
     * @alias module:model/GetAIServiceModelsApiModel
     */
    constructor() { 
        
        GetAIServiceModelsApiModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetAIServiceModelsApiModel();
 ...
 */
GetAIServiceModelsApiModel.prototype['inquiry'] = undefined;
