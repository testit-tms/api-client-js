...
class TagsFilterApiModel {
    /**
     * Constructs a new <code>TagsFilterApiModel</code>.
     * @alias module:model/TagsFilterApiModel
     */
    constructor() { 
        
        TagsFilterApiModel.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new TagsFilterApiModel();
