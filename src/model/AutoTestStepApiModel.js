...
class AutoTestStepApiModel {
    ...
    constructor(title) { 
        ...
        AutoTestStepApiModel.initialize(this, title);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AutoTestStepApiModel();
    ...
    static validateJSON(data) {
        ...
        for (const property of AutoTestStepApiModel.RequiredProperties) {
 ...
 * @member {String} title
 */
AutoTestStepApiModel.prototype['title'] = undefined;

/**
 * Detailed step description. It appears when the step is unfolded.
 * @member {String} description
 */
AutoTestStepApiModel.prototype['description'] = undefined;
 ...
 */
AutoTestStepApiModel.prototype['steps'] = undefined;
