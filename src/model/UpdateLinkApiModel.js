...
class UpdateLinkApiModel {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateLinkApiModel();
    ...
    static validateJSON(data) {
        ...
        for (const property of UpdateLinkApiModel.RequiredProperties) {
 ...
 * @member {String} id
 */
UpdateLinkApiModel.prototype['id'] = undefined;

/**
 * Link name.
 * @member {String} title
 */
UpdateLinkApiModel.prototype['title'] = undefined;

/**
 * Address can be specified without protocol, but necessarily with the domain.
 * @member {String} url
 */
UpdateLinkApiModel.prototype['url'] = undefined;

/**
 * Link description.
 * @member {String} description
 */
UpdateLinkApiModel.prototype['description'] = undefined;

/**
 * Specifies the type of the link.
 * @member {module:model/LinkType} type
 */
UpdateLinkApiModel.prototype['type'] = undefined;

/**
 * Flag defines if link relates to integrated jira service
 * @member {Boolean} hasInfo
 */
UpdateLinkApiModel.prototype['hasInfo'] = undefined;
