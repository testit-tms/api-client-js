...
export class CustomAttributeTemplatesApi {
     ...
     * @param name 
     */
    public async apiV2CustomAttributesTemplatesExistsGet (name?: string, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body: CustomAttributeTemplateValidationResult;  }> {
     ...
     * @param requestBody 
     */
    public async apiV2CustomAttributesTemplatesIdCustomAttributesExcludePost (id: string, requestBody?: Array<string>, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param requestBody 
     */
    public async apiV2CustomAttributesTemplatesIdCustomAttributesIncludePost (id: string, requestBody?: Array<string>, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param id Attribute template internal (UUID) identifier
     */
    public async apiV2CustomAttributesTemplatesIdDelete (id: string, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public async apiV2CustomAttributesTemplatesIdGet (id: string, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body: CustomAttributeTemplateModel;  }> {
        const localVarPath = this.basePath + '/api/v2/customAttributes/templates/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async apiV2CustomAttributesTemplatesNameGet (name: string, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body: CustomAttributeTemplateModel;  }> {
     ...
     */
    public async apiV2CustomAttributesTemplatesPost (customAttributeTemplatePostModel?: CustomAttributeTemplatePostModel, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body: CustomAttributeTemplateModel;  }> {
     ...
     */
    public async apiV2CustomAttributesTemplatesPut (customAttributeTemplatePutModel?: CustomAttributeTemplatePutModel, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/api/v2/customAttributes/templates';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
     ...
     */
    public async apiV2CustomAttributesTemplatesSearchPost (skip?: number, take?: number, orderBy?: string, searchField?: string, searchValue?: string, customAttributeTemplateSearchQueryModel?: CustomAttributeTemplateSearchQueryModel, options: {headers: {[name: string]: string}, rejectUnauthorized: boolean} = {headers: {}, rejectUnauthorized: true}) : Promise<{ response: http.IncomingMessage; body: Array<SearchCustomAttributeTemplateGetModel>;  }> {
