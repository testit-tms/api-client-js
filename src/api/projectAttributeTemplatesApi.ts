...
export enum ProjectAttributeTemplatesApiApiKeys {
    'Bearer or PrivateToken',
}

export class ProjectAttributeTemplatesApi {
    ...
    public setApiKey(key: ProjectAttributeTemplatesApiApiKeys, value: string) {
        (this.authentications as any)[ProjectAttributeTemplatesApiApiKeys[key]].apiKey = value;
    }
