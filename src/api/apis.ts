export * from './aIServicesAPIApi';
import { AIServicesAPIApi } from './aIServicesAPIApi';
...
import { ExternalServicesApi } from './externalServicesApi';
export * from './failureCategoriesApi';
import { FailureCategoriesApi } from './failureCategoriesApi';
...
export * from './projectExternalServicesApi';
import { ProjectExternalServicesApi } from './projectExternalServicesApi';
export * from './projectFailureCategoriesApi';
import { ProjectFailureCategoriesApi } from './projectFailureCategoriesApi';
...
export * from './userStoragesApi';
import { UserStoragesApi } from './userStoragesApi';
...
export const APIS = [AIServicesAPIApi, AttachmentsApi, AutoTestsApi, BackgroundJobsApi, ConfigurationsApi, CustomAttributeTemplatesApi, CustomAttributesApi, ExternalServicesApi, FailureCategoriesApi, NotificationsApi, ParametersApi, ProjectAttributeTemplatesApi, ProjectAttributesApi, ProjectConfigurationsApi, ProjectExternalServicesApi, ProjectFailureCategoriesApi, ProjectSectionsApi, ProjectSettingsApi, ProjectTestPlanAttributesApi, ProjectTestPlanTestPointsApi, ProjectTestPlansApi, ProjectWorkItemsApi, ProjectsApi, SearchApi, SectionsApi, TagsApi, TestPlansApi, TestPointsApi, TestResultsApi, TestRunsApi, TestSuitesApi, UserStoragesApi, UsersApi, WebhooksApi, WebhooksLogsApi, WorkItemsApi, WorkItemsCommentsApi];
