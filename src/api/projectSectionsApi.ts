...
export enum ProjectSectionsApiApiKeys {
...
export class ProjectSectionsApi {
    ...
    public setApiKey(key: ProjectSectionsApiApiKeys, value: string) {
        (this.authentications as any)[ProjectSectionsApiApiKeys[key]].apiKey = value;
    }
