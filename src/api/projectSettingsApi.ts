...
export enum ProjectSettingsApiApiKeys {
...
export class ProjectSettingsApi {
    ...
    public setApiKey(key: ProjectSettingsApiApiKeys, value: string) {
        (this.authentications as any)[ProjectSettingsApiApiKeys[key]].apiKey = value;
    }
